  ...
  return (
    <div className="flex gap-8">
      ...
      <article className="min-w-0 flex-1">
        ...
        <MarkdownContent
          html={htmlContent}
          className="prose prose-slate dark:prose-invert max-w-none prose-headings:scroll-mt-20 prose-a:text-brand-600 dark:prose-a:text-brand-400 prose-code:before:content-none prose-code:after:content-none prose-code:bg-[var(--code-bg)] prose-code:rounded prose-code:px-1 prose-code:py-0.5"
        />
